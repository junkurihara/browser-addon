...
export function showMessageIframe() {
    const iframeElement: HTMLIFrameElement = document.getElementById("ijctdIframeElement") as HTMLIFrameElement;
...
export function setupIframe() {
    ...
    addStyle(iframeWindow.document, "https://fonts.googleapis.com/css?family=Roboto:100,300,400,500,700,900");
    addStyle(iframeWindow.document, "https://cdn.jsdelivr.net/npm/@mdi/font@4.x/css/materialdesignicons.min.css");
    showMessageIframe();
}
